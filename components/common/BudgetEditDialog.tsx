...
const BudgetEditDialog = ({
  ...
  const handleSave = () => {
    ...
    const totalBudget = budgetInput ? Number(budgetInput.replace(/,/g, "")) : undefined;
      ...
      <div className="flex flex-col gap-5">
        ...
        <Tabs value={mode} onValueChange={(v) => setMode(v as BudgetMode)}>
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex items-start gap-2 rounded-xl border border-[#E2E2E2] px-3 py-2">
                ...
                <p className="typography-body-sm-reg text-muted-foreground">
                  예산을 미리 설정하고, 설정한 예산을 기준으로 남은 예산과 지출액을 확인할 수
                  있습니다.
                </p>
              </div>
              ...
              <BudgetInputField
                ...
                onChange={(v) => {
                  ...
                  setPersonInput(v.replace(/[^0-9]/g, ""));
                }}
                unit="명"
          ...
          <TabsContent value="expense">
            <div className="flex min-h-58 flex-col gap-4">
              {/* 안내 카드 */}
              <div className="flex items-start gap-2 rounded-xl border border-[#E2E2E2] px-3 py-2">
                <CircleHelp
                  className="text-muted-foreground mt-0.5 size-5 shrink-0"
