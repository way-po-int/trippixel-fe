...
export default function VoteBtn({ type, count, isActive, onToggle, onCountClick }: VoteBtnProps) {
  return (
    <div
    ...
    >
      <VoteItem type={type} isActive={isActive} onToggle={onToggle} />

      {/* Divider */}
      <div className="h-4.5 w-px shrink-0 bg-[rgba(1,1,46,0.13)]" />

      <VoteCount count={count} onClick={onCountClick} />
    </div>
  );
}
