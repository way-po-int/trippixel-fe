...
const CandidateManualAddPlacePage = () => {
  ...
  const handleAddCandidate = () => {
    ...
    if (collectionId) nextQuery.set("collectionId", collectionId);
    if (timeBlockId) nextQuery.set("timeBlockId", timeBlockId);

    // TODO: candidate-select 수동 입력 전용 후보지 추가 API 연결 후 direct add로 전환
    router.push(`/projects/${planId}/place-add?${nextQuery.toString()}`);
  };
...
export default CandidateManualAddPlacePage;
